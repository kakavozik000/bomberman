...
"""
1. Сделать возможность взрываться бомбочке и второого игроку (точно также всё скопировать из первого БОА)
2. Картинку "грустного" Тайланда
3. Поиграть в БЛ
4. лазщэыокушпхыг
5. реагкенгс
6. Разобраться с картинками (бомбочкеи пропали, попробовать сохранить в другом формате в ибисе)
